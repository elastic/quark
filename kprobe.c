	...
	0,
{
	...
	{ "stack_90",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +728"	},
	{ "stack_91",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +736"	},
	{ "stack_92",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +744"	},
	{ "stack_93",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +752"	},
	{ "stack_94",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +760"	},
	{ "stack_95",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +768"	},
	{ "stack_96",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +776"	},
	{ "stack_97",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +784"	},
	{ "stack_98",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +792"	},
	{ "stack_99",	"di",	"u64",	  "task_struct.mm mm_struct.(anon).start_stack +8 +800"	},
	{ "comm",	"di",	"string", "task_struct.comm"					},
}};
